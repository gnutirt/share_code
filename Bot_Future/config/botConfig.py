...
TEST_MODE = True  # True: Chạy test, False: Chạy thật
...
API_REQUEST_INTERVAL = 150  # Giây giữa mỗi request API
CHECK_PROFIT_INTERVAL = 5
CHECK_ORDER_INTERVAL = 150
...
GRID_ORDER_VALUE = 10 # Giá trị cơ bản cho lệnh grid - USD
